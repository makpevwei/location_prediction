...
def make_predictions():
    if request.method == 'POST':
        loc_month = request.args.get('loc_month')
        loc_date = request.args.get('loc_date')
        loc_hour = request.args.get('loc_hour')
        loc_min = request.args.get('loc_min')
        loc_sec = request.args.get('loc_sec')
